...
class CharacterMenu1:
    ...
    def run(self):
        ...
        bouton_next = Button((self.previous_menu.largeur / 2) + 615, (self.previous_menu.hauteur / 2) + 360, 130, 40,
                             self.previous_menu.font, 'Next',
                             self.on_click_next, False, ('#2a75a1', '#666666', '#333333'))
        bouton_back = Button((self.previous_menu.largeur / 2) - 745, (self.previous_menu.hauteur / 2) + 360, 130, 40,
                             self.previous_menu.font, 'Back',
                             self.on_click_back, False, ('#2a75a1', '#666666', '#333333'))
        bouton_choice1 = Button((self.previous_menu.largeur / 2) - 450, (self.previous_menu.hauteur / 2), 130, 40,
                                self.previous_menu.font, 'Choice1',
                                self.on_click_choice1, False, ('#2a75a1', '#666666', '#333333'))
        bouton_choice2 = Button((self.previous_menu.largeur / 2) - 60, (self.previous_menu.hauteur / 2), 130, 40,
                                self.previous_menu.font, 'Choice2',
                                self.on_click_choice2, False, ('#2a75a1', '#666666', '#333333'))
        bouton_choice3 = Button((self.previous_menu.largeur / 2) + 350, (self.previous_menu.hauteur / 2), 130, 40,
                                self.previous_menu.font, 'Choice3',
                                self.on_click_choice3, False, ('#2a75a1', '#666666', '#333333'))
        label_title = Label("PythonBlyat", 100, (0, 0, 0),
                            (self.previous_menu.largeur / 2, self.previous_menu.hauteur / 2 - 300), None, True)
        label_selection = Label("Choose your character1", 50, (0, 0, 0),
                                (self.previous_menu.largeur / 2, self.previous_menu.hauteur / 2 - 150),
                                None, True)
